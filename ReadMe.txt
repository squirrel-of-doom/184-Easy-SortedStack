========================================================================
    KONSOLENANWENDUNG: 184-Easy-SortedStack-Projektübersicht
========================================================================

Diese 184-Easy-SortedStack-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre 184-Easy-SortedStack-Anwendung besteht.


184-Easy-SortedStack.vcxproj
...
184-Easy-SortedStack.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "184-Easy-SortedStack.pch und eine 
